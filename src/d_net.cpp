...
{
	// This function is kept for compatibility but the actual processing
	// is now done in AP_Tick() which is called from archipelago_ccmds.cpp
	// The AP_Tick() function is called directly in D_DoomLoop()
}
